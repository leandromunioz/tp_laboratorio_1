	...
	do {
		...
		case 3:
			if (banderaPrimerOperando == 1) {
				primerOperando =
						IngresarNumero(
								"Por favor, ingrese el operando solicitado para realizar las operaciones.");
				banderaPrimerOperando = 0;
			}
			if (banderaSegundoOperando == 1) {
				segundoOperando =
			...
			resultadoMultiplicacion = Operaciones(primerOperando,
					segundoOperando, '*');
		...
		case 4:
			if (banderaOperacionesSinCompletar == 1) {
				printf(
						"El programa debe calcular todas las operaciones antes de poder mostrar el resultado.");
			} else {
				printf(
				...
				if (primerOperando < 0
						|| ValidarFlotante(primerOperando) == 1) {
					printf(
				...
				if (segundoOperando < 0
						|| ValidarFlotante(segundoOperando) == 1) {
					printf(
